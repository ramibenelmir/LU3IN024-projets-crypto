...
Pour chaque binôme, *un seul d’entre vous* devra faire un /fork/ de ce squelette de projet, puis y ajouter son camarade de binôme, et ainsi partager le projet sous GitLab. Pour cela :
  ...
  - Dans l’onglet =Projects > Your projects=, sélectionnez ce projet privé. Il doit avoir pour nom =username/TME= et porter la mention =Forked from CRYPTO-2023/TME=. Cliquez sur =Project Information= dans le menu de gauche, puis =Members=. *Invitez votre binôme* en lui donnant pour rôle =Maintainer=.
...
** Mettre à jour sa version du TME
   ...
   #+begin_src shell
     ...
     git remote add upstream https://stl.algo-prog.info/crypto-2023/tme5-ecc
   #+end_src
